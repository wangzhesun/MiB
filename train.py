...
class Trainer:
    ...
    def train(self, cur_epoch, optim, train_loader, scheduler=None, print_int=10, logger=None):
        ...
        for cur_step, (images, labels) in enumerate(train_loader):
            ...
            #################################################################3
            # print('\n printing size of training image: ')
            # print(images.size())
            # print('printing max value of training image: ')
            # print(torch.max(images))
            # print('printing min value of training image: ')
            # print(torch.min(images))
            # print('printing underlying data type of training image: ')
            # print(torch.max(images).dtype)
            # print(images.is_cuda)
            # print('\n printing size of training label: ')
            # print(labels.size())
            # print('printing max value of training label: ')
            # print(torch.max(labels))
            # print('printing min value of training label: ')
            # print(torch.min(labels))
            # print('printing underlying data type of training label: ')
